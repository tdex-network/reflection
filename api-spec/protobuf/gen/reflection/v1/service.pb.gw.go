...
func request_ReflectionService_GetInfo_0(ctx context.Context, marshaler runtime.Marshaler, client ReflectionServiceClient, req *http.Request, pathParams map[string]string) (ReflectionService_GetInfoClient, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
	stream, err := client.GetInfo(ctx)
	if err != nil {
...
func RegisterReflectionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReflectionServiceServer) error {
	...
	mux.Handle("POST", pattern_ReflectionService_GetInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterReflectionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReflectionServiceClient) error {
	...
	mux.Handle("POST", pattern_ReflectionService_GetInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/reflection.v1.ReflectionService/GetInfo", runtime.WithHTTPPathPattern("/v1/info"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ReflectionService_GetInfo_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_ReflectionService_GetInfo_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ReflectionService_GetInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "info"}, ""))
)

var (
	forward_ReflectionService_GetInfo_0 = runtime.ForwardResponseStream
)
